...
import skripsi.rizky.absensi.adapter.ListKelasAdapter;
...
public class DataParserKelas extends AsyncTask<Void, Void, Boolean> {
    ...
    public DataParserKelas(Context context, String jsonData, RecyclerView rv, SwipeRefreshLayout swipeRefreshLayout) {
    ...
    protected void onPostExecute(Boolean isParsed) {
        ...
        if (isParsed) {
            ...
            rv.setAdapter(new ListKelasAdapter(context, sesiDatas));
        } else {

            Toast.makeText(context, "Tidak ada kelas yang dibuka", Toast.LENGTH_SHORT).show();
        }
    }
