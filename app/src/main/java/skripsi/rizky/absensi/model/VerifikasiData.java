...
public class VerifikasiData implements Serializable {
    ...
    public String getToken_absen() {
        return token_absen;
    }

    public void setToken_absen(String token_absen) {
        this.token_absen = token_absen;
    }
}
