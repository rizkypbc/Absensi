...
if (isset($_POST['pertemuan']) && isset($_POST['materi']) && isset($_POST['nama_dosen']) && isset($_POST['ruang']) && isset($_POST['keterangan']) && isset($_POST['kode_matkul'])) {
	...
	$sql = $MySQLiconn->query("INSERT INTO sesi(materi, nama_dosen, pertemuan, ruang, tanggal, waktu, keterangan, kode_matkul, token_sesi) VALUES ('$materi', '$nama_dosen', '$pertemuan', '$ruang', now(), now(), '$keterangan', '$kode_matkul', 'Invalid')");
